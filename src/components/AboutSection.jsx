...
const AboutSection = () => {
  ...
  return (
    <div className={`max-w-4xl w-full mx-auto px-6 py-20 transition-all duration-1000 
      ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
    >
      <div className="flex flex-col items-center">
        {/* Profile Image */}
        <div className={`mb-12 relative group transform transition-all duration-1000 
        ...
        <div className={`flex flex-col items-center gap-6 mt-8 transition-all duration-1000 delay-500
          ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
        >
          {/* Social Links */}
