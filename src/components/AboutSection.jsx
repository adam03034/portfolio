    ...
    <div className="w-full min-h-screen flex items-center justify-center">
      ...
      >
        <div className="flex flex-col items-center justify-center gap-10">
          ...
          >
            <div className="relative group">
              ...
              <img
                ...
                alt="Profile"
                className="relative w-40 h-52 object-cover rounded-2xl transform transition-all duration-500 
          ...
          {/* Dynamic Text */}
          <div className="text-center relative min-h-[150px] flex flex-col items-center justify-center">
            <div className="relative">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 flex items-center justify-center gap-2">
                ...
                <span className="min-w-[2ch] text-center">
                  {displayText}
                  <span className={`inline-block w-[2px] h-10 bg-gray-800 ml-1 
            ...
            <p className={`text-base md:text-lg opacity-60 max-w-xl mx-auto transition-all duration-1000 delay-300
          ...
          <a
            ...
            download
            className="w-auto flex items-center justify-center gap-2 px-8 py-2.5 rounded-xl 
